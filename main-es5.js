...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function AppComponent_app_card_pokemon_10_Template(rf, ctx) {
      if (rf & 1) {
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 11,
      vars: 5,
      consts: [[1, "app-container"], [1, "actions-mobile"], ["type", "text", "placeholder", "Buscar pokemon", 1, "form-control", "search-input", 3, "ngModel", "ngModelChange"], [1, "actions"], ["type", "button", 1, "btn", "btn-primary", 3, "disabled", "click"], [1, "content"], [3, "pokemon", 4, "ngFor", "ngForOf"], [3, "pokemon"]],
